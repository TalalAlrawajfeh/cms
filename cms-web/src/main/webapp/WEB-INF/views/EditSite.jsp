						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-6">
								<input type="text" disabled id="username" class="form-control"
									placeholder="Site URI" required autofocus>
							</div>
						</div>
						<div class="row form-group">
							<label class="col-xs-12 col-sm-3">Parent Site</label>
							<div class="col-xs-12 col-sm-6">
								<select name="parent-site" disabled class="form-control">
						...
						<div class="row form-group">
							...
							<div class="col-xs-12 col-sm-6">
								<select name="parent-site" class="form-control">
									...
									<option value="/services">Page1 - /page1</option>
									<option value="/products">Page2 - /page2</option>
								</select>
							</div>
						</div>
						<div class="row form-group">
