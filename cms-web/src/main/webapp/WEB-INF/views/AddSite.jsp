      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">          
          <ul class="nav navbar-nav navbar-right">
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-user"></i>Admin<span class="caret"></span></a>
		<ul class="dropdown-menu">
		<li><a href="./ChangePassword.html"><i class="glyphicon glyphicon-pencil"></i>Change Password</a></li>
	  ...
	  <form class="form-horizontal">
		...
		<div class="row form-group">
			<div class="col-xs-12 col-sm-6 col-sm-offset-3">
				...
				<a class="btn btn-danger" href="./sites.html">Cancel</a>&nbsp;
			</div>
		</div>
	  </div>
          </form>
